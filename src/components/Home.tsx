...
export default function Home() {
    ...
    return (
        <div className="relative overflow-hidden min-h-screen">
            ...
            <AlertDialog open={isMobilePromptOpen} onOpenChange={setIsMobilePromptOpen}>
                <AlertDialogContent className="rounded-md w-[95%] sm:w-auto">
                    <AlertDialogHeader>
                        <AlertDialogTitle>Limited Functionality</AlertDialogTitle>
                        <AlertDialogDescription>
                            To experience all editing functionalities, please open on a desktop.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
            ...
            >
              ...
              Create&nbsp;
                ...
                />
                    ...
                    <div className="text-center -mt-5 font-medium text-base sm:text-[22px] leading-5 sm:leading-7">
                ...
                <div
                    ...
                    style={{ boxShadow: "2px 4px 12px rgba(0, 0, 0, 0.2)" }}
                >
                    <input
                        type="url"
